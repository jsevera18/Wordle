...
public class WordleGUI {
	 ...
	 */
	public WordleGUI() {
		//this.game = new Wordle("dictLen5.txt");
		//this.game = new Wordle("textlen5.txt");
		//this.game = new Wordle("text.txt");
		//this.game = new Absurdle("dictionary.txt");
		this.game = new Wordle("dictionary.txt");
		//this.game = new Absurdle("text.txt");
		initialize();
	}
	...
	public void reset() {
		this.game.reset();
		message.setText("Welcome to the game of wordle.");
	 ...
	 */
	public void guess() {
		String next = textPane.getText().toLowerCase();
		textPane.setText("");
		if (next.length() > 0) {
			String mess = game.makeGuess(next);
			if(mess.startsWith("Error")) {
				message.setText("Welcome to Wordle \n"+mess);
			}
			else {
				message.setText("Welcome to Wordle");
				//redacted.setText(game.getCorrectWord());
