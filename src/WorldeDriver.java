...
public class WorldeDriver {
	...
	public static void main(String[] args) {
		...
		boolean play = true;
		while (play) {
			//Wordle game = new Wordle("dictionary.txt");
			Wordle game = new Wordle("CSC 421 HW2/src/text.txt");
			//Wordle game = new Wordle("text2.txt");
			//Wordle game = new Absurdle("dictionary.txt");
			//Wordle game = new Absurdle("dictlen5.txt");
			//Wordle game = new Absurdle("text.txt");
			...
			//System.out.println("The word has "+game.getCorrectWord()+" letters");
			//System.out.println("The word has "+game.getCorrectWord()+" letters");
			while (!game.gameOver()) {
				System.out.println();
